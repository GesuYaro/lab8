...
public abstract class AbstractStreamAPIRowSorter<M, I> extends RowSorter<M> {
    /**
     ...
     */
    public AbstractStreamAPIRowSorter() {
    ...
    private void sortExistingData() {
        ...
        if (isUnsorted()) {
            ...
            // sort the data
            viewToModel = Arrays.stream(viewToModel)
                    .sorted()
                    .toArray(Row[]::new);
